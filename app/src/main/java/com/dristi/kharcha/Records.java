...
public class Records extends Fragment{
    ...
    TextView income, expense, norecord, totalincome, totalexpense;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        preferences = getActivity().getSharedPreferences("IncExp",0);
        ...
        setdate(df.format(Calendar.getInstance().getTime()));
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                ...
                displaytotalexpense(getDate());
                displaytotalincome(getDate());
            }
        });
    ...
    public void displaytotalincome(String value){

        totalincome.setText(String.valueOf(dbhelper.gettotalincome(value)));
    }

    public void displaytotalexpense(String value){
        totalexpense.setText(String.valueOf(dbhelper.gettotalexpense(value)));
    }
